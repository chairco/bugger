...
urlpatterns = [
    ...
    url(r'^add/$', login_required(views.BuglistCreateView.as_view()), name='buglist_add'),
    url(r'^(?P<pk>\d+)/edit/$', login_required(views.BuglistUpdateView.as_view()), name='buglist_edit'),
